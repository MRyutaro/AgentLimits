...
## ダウンロード
最新版はこちらからダウンロードしてください: [ダウンロード](https://github.com/MRyutaro/AgentLimits/releases/latest/download/AgentLimits.zip)
...
- 実行コマンド例:
  ...
  - `claude -p "hello"`
- LaunchAgentのplist: `~/Library/LaunchAgents/com.matsumotoryutaro.agentlimit.wakeup-*.plist`
